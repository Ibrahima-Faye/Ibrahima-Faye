...
- **Expertises** : 7 domaines, chacun avec une illustration technique animée en SVG + CSS pur (aucun WebGL), remplaçable
  par une vraie image ou vidéo (`src/assets/domaines/<domaine>.jpg|mp4`).
